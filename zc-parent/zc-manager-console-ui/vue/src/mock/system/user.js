...
Mock.mock('/api/v1/system/user/save', save)
...
Mock.mock(/\/api\/v1\/system\/user\/del\?id=.+/, del)
...
Mock.mock(/\/api\/v1\/system\/user\/queryById\?id=.+/, queryById)
...
Mock.mock('/api/v1/system/user/queryByPage', queryByPage)
