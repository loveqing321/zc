...
Mock.mock('/api/v1/system/permission/save', save)
...
Mock.mock(/\/api\/v1\/system\/permission\/del\?id=.+/, del)
...
Mock.mock(/\/api\/v1\/system\/permission\/queryById\?id=.+/, queryById)
...
Mock.mock('/api/v1/system/permission/queryByPage', queryByPage)
